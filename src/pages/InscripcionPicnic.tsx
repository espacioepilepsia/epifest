...
const InscripcionPicnic = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await fetch('https://script.google.com/macros/s/AKfycbx4HywGX5k5IkhyoEgClwkagjf6lQQpCCIo5sDL-0WR7X6mFSRl6JbfyLZbOT1HKbKw/exec', {
        method: 'POST',
    ...
    setLoading(false);
    if (err) {
      setError('Hubo un error al enviar tu inscripción. Intentá de nuevo.');
    } else {
      setSuccess(true);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Inscripción al Picnic Purple Day"
        description="Inscribite al Picnic de Purple Day del epifest! 2026. 27 de marzo, Plaza Mafalda, CABA. Un encuentro para conectar, compartir y cocrear."
        canonical="/inscripcion-picnic"
      />
        ...
        <div className="container mx-auto max-w-3xl relative z-10" ref={ref}>
          <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7 }}>
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-6">
              ¡Inscripción al<br />
              <span className="text-gradient-gold">Picnic de Purple Day!</span>
            </h1>
            <p className="text-lg text-foreground/70 leading-relaxed mb-4">
              <span className="font-semibold text-foreground">¡Te invitamos al Picnic de Purple Day!</span><br />
              Un encuentro para conectar, compartir y cocrear el 2026.
            </p>
            <p className="text-base text-foreground/60 leading-relaxed mb-4">
              En <span className="font-semibold text-foreground">Fundación Espacio Epilepsia</span>, creemos que los encuentros presenciales son la mejor herramienta para reducir el aislamiento y fortalecer nuestra comunidad. Por eso, queremos cerrar el Epifest! con un <span className="font-semibold text-foreground">picnic al aire libre</span> diseñado para escucharnos, compartir momentos entre todos, y conectar en comunidad.
            </p>
            <p className="text-base text-foreground/60 leading-relaxed mb-8">
              Este es un espacio seguro y humano pensado para personas con epilepsia, familiares, amigos, profesionales de la salud y organizaciones que quieran sumarse a transformar la realidad de nuestra comunidad.
            </p>
            <button onClick={scrollToForm} className="btn-gold text-base">
              ¡Inscribite ahora!
            </button>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto max-w-3xl">
          ...
          >
            <div className="flex items-center gap-2 mb-5">
              ...
              <h2 className="text-xl font-extrabold">Detalles del Evento</h2>
            </div>
            ...
            <div className="glass-card rounded-2xl p-5 mb-8">
              ...
              <p className="text-sm text-foreground/70 leading-relaxed">
                Dinámicas para conocernos, resumen del Epifest, charlas guiadas sobre nuestras experiencias y un espacio especial para dejar "Mensajes de felicidad" en nuestra red comunitaria.
              </p>
            </div>
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-base text-foreground/60 leading-relaxed">
                  Queremos conocer tus necesidades reales y que tu voz ayude a mejorar la representatividad de las personas con epilepsia. Vení a compartir una tarde de mantas, cintas violetas y construcción colectiva.
                </p>
              </div>
            </div>

            <p className="font-bold text-foreground/90 mt-6 mb-10">
          ...
          {success ? (
            ...
            >
              ...
              <p className="text-foreground/70">
                Nos vemos el <span className="font-semibold text-foreground">27 de marzo</span> en Plaza Mafalda. ¡Te esperamos!
              </p>
            </motion.div>
          ) : (
            <motion.form
            ...
            >
              ...
              {/* Relación con epilepsia */}
              <div>
                <label className="text-xs font-semibold text-foreground/60 uppercase tracking-wider mb-1.5 block">
                  ¿Cuál es tu relación con la epilepsia? *
                </label>
                <div className="relative">
                  <select name="relacion" required defaultValue="" className={selectClass}>
                    <option value="" disabled>Seleccioná una opción</option>
                    {relacionOptions.map(opt => (
              ...
              <div>
                <label className="text-xs font-semibold text-foreground/60 uppercase tracking-wider mb-1.5 block">
                  ¿Te interesa recibir información sobre epilepsia y próximos eventos? *
                </label>
                <div className="relative">
