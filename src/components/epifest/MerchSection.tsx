          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.map((product, i) => (
              ...
              >
                ...
                {product.description && (
                  <p className="text-sm text-foreground/70 mt-1 flex-1">{product.description}</p>
                )}
                <p className="text-2xl font-extrabold text-secondary mt-3">{formatPrice(product.price)}</p>
                <a
