...
const editions = [
  { year: '2025', tagline: '4ta Edición — Expandiendo fronteras', link: '/edicion/2025' },
  { year: '2024', tagline: '3ra Edición — Comunidad en acción', link: '/edicion/2024' },
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {editions.map((ed, i) => (
            ...
            >
              <Link
                to={ed.link}
                className="glass-card rounded-2xl p-6 hover:scale-105 transition-transform group block"
              >
