      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        >
          ...
          <span className="text-xs font-bold uppercase tracking-[0.3em] text-accent">
            Purple Day · Día Internacional de la Epilepsia
          </span>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Picnic de<br />
              <span className="text-gradient-gold">Purple Day</span> 🌿
            </motion.h2>
            ...
            >
              Cerramos el congreso con un picnic al aire libre para conectarnos, 
              celebrar los logros y coconstruir el camino del próximo año juntos.
            ...
            >
              El formato elegido favorece la participación, la apertura emocional y la
              conversación espontánea. Abierto a personas con epilepsia, familias, amigos
          ...
          <div className="grid grid-cols-2 gap-4">
            {highlights.map((item, i) => (
              ...
              >
                ...
                <div>
                  <p className="text-[10px] uppercase tracking-widest text-foreground/40 font-semibold mb-0.5">
                    {item.label}
                  </p>
            ...
            >
              <p className="text-[10px] uppercase tracking-widest text-foreground/40 font-semibold mb-3">
                ¿Qué vamos a hacer?
              </p>
              <ul className="space-y-1.5">
                {[
                  '🤝 Conectarnos con la comunidad',
                  '💜 Concientizar sobre Purple Day',
                  '🌱 Coconstruir el próximo año',
                  '🎉 Celebrar los logros del congreso',
                ].map((item) => (
